...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("ember-stability-experiment/app").default.create({name:"ember-stability-experiment",version:"0.0.0+4593cf29"})
